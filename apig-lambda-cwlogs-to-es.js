// v1.1.2 [Originally generated by AWS | adjusted by SeboLabs]
...
function transform(payload) {
    ...
    payload.logEvents.forEach(function(logEvent) {
        ...
        } else if(payload.logGroup.startsWith('API-Gateway-Execution-Logs')) {
        ...
        var indexName = [
            'cwl-' + index_prefix + timestamp.getUTCFullYear(), // year
